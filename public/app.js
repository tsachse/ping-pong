...
$packages["main"] = (function() {
	...
	Model.ptr.prototype.Ping = function() {
		...
		$go((function $b() {
			var _r, err, res, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _r = $f._r; err = $f.err; res = $f.res; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			...
			res = new Result.ptr(req.Object.response);
			m.Object.my_result = $externalize(res, ptrType);
			m.Object.test = $externalize("Ping-Pong mit GopherJS", $String);
			$s = -1; return;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f._r = _r; $f.err = err; $f.res = res; $f.$s = $s; $f.$r = $r; return $f;
		}), []);
	};
